...
<main>
	...
	<form action="./manage.php" method="post">
		...
		<input type ="hidden" name="review_id"
			value="<?php echo $review_id_chosen?>"> <input type="radio"
			id="1-star" name="rating" value="1"> <label for="1-star">1 Star</label>
		<br>
		<input type="radio" id="2-star" name="rating" value="2"> <label
			for="2-star">2 Stars</label> <br>
		<input type="radio" id="3-star" name="rating" value="3"> <label
			for="3-star">3 Stars</label> <br>
		<input type="radio" id="4-star" name="rating" value="4"> <label
			for="4-star">4 Stars</label> <br>
		<input type="radio" id="5-star" name="rating" value="5"> <label
			for="5-star">5 Stars</label> <br>
		<br>

		<label for="review_text">Review:</label> <br>
		<textarea id="review_text" rows="8" cols="50" name="review_text"><?php echo trim($review_info['review']) ?></textarea>
		<br>

		<input type="submit" value="Edit Review"> <label>&nbsp;</label>
	</form>
	<?php endif; ?>
